...
GO
	...
	-- Description:   
	-- =============================================  
	ALTER procedure [dbo].[tp_getDD_PeriodeException] @PeriodType varchar(max) = '' as
set
	@PeriodType = dbo.fn_StripCharacters(@PeriodType, '^a-zA-Z0-9 [-]_@.!#$&/\[]') if @PeriodType = '' begin
select
	PeriodType as id,
	PeriodType as [desc]
from
