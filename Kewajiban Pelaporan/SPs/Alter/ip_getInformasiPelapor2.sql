alter PROCEDURE [dbo].[ip_getInformasiPelapor2] AS BEGIN
SELECT
    b.InstansiId,
    a.IdPelapor,
    ...
    '<p>' + STRING_AGG(
        CONVERT(
            VARCHAR(MAX),
            CASE
                WHEN a.Periode = 'W' THEN c.namainformasi
                ELSE NULL
            END
        ),
        '</p><p>'
    ...
    '<p>' + STRING_AGG(
        CONVERT(
            VARCHAR(MAX),
            CASE
                WHEN a.Periode = 'M' THEN c.namainformasi
                ELSE NULL
            END
        ),
        '</p><p>'
    ...
    '<p>' + STRING_AGG(
        CONVERT(
            VARCHAR(MAX),
            CASE
                WHEN a.Periode = 'Q' THEN c.namainformasi
                ELSE NULL
            END
        ),
        '</p><p>'
    ...
    '<p>' + STRING_AGG(
        CONVERT(
            VARCHAR(MAX),
            CASE
                WHEN a.Periode = 'S' THEN c.namainformasi
                ELSE NULL
            END
        ),
        '</p><p>'
    ...
    '<p>' + STRING_AGG(
        CONVERT(
            VARCHAR(MAX),
            CASE
                WHEN a.Periode = 'A' THEN c.namainformasi
                ELSE NULL
            END
        ),
        '</p><p>'
